...
const SearchBox = ({ isOpen }) => {
  ...
  return (
    <div className="">
      <div className={`search flex justify-between items-center px-[24px] md:px-[150px] ${isOpen ? 'ml-[240px]' : ''}`}>
        <div className="flex items-center relative lg:w-[594px]">
          ...
          <input
            type="text"
            name="search"
            className="mt-1 w-full outline-none bg-[#F8F8F8] text-[14px] border p-2 border-[#ECEDEE] shadows h-[32px] rounded-[16px]"

          ...
          <div className="users bg-[#FFFFFF] rounded-xl lg:w-[80%]">
            ...
            <div className=" ">
              <form >
                ...
                <div>
                  <label for="middle_name" className="font-medium text-[14px] mt-5 leading-[18px] text-[#3D3D3D]  block">First name</label>
                  <input
                    type="text"
                    name="middle_name"
                  ...
                  />
                  {errors.midlle_name && (
                    <span className=" text-red-500 block p-[8px]">Enter Middle name *</span>
                  )}
                </div>
                </div>
                <div className='block lg:grid grid-cols-2 gap-5 mt-5'>

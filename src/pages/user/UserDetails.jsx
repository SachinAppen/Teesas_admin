...
const UserDetails = ({isOpen, togglesidebar }) => {
  ...
  return (
    ...
    <FaChevronLeft />
    <div>
     <div className=' font-normal text-[14px] lg:text-[16px] leading-[20px] text-[#B6B6B6]'>Home / Users/<span className='text-black font-medium'>UserDetails</span></div>
    </div>
    </div>
          ...
          <div className=" w-full rounded-2xl border py-[10px] px-[12px] lg:px-[18px]  bg-[#FFFFFF] ">
            ...
            <div className="mt-5 bg-[#F2F2F2] rounded-2xl px-[13px] lg:px-[20px] py-[20px]" >
              <div className="flex justify-between items-center ">
                ...
                <div className=" text-green-500 cursor-pointer" onClick={ ()=>{Navigate('/EditUser')}}>
                  Edit
                </div>
              </div>
              <div className="bg-[#FFFFFF] py-[10px] px-[10px] mt-[10px] rounded-[8px] flex flex-col gap-4" >
          ...
          />
            ...
            <div className="mt-5 bg-[#F2F2F2] rounded-2xl px-[13px] lg:px-[20px] py-[20px]" >
              <div className="flex justify-between items-center ">
                ...
                <div className=" text-[#F2994A] cursor-pointer" onClick={ ()=>{Navigate('/Parent')}}>
                  Edit
                </div>
              </div>
              <div className="bg-[#FFFFFF] py-[10px] px-[10px] mt-[10px] rounded-[8px] flex flex-col gap-4" >
